{{-- resources\views\pages\shared\manage-request-ticket.blade.php --}}
@extends('layouts.layout')

@section('content')

    @php
        $pendingCount = $requests->where('type', 'trip_ticket_request')->count();
    @endphp
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                ...
                <div>
                    <h1 class="text-4xl font-bold tracking-tight">
                        TRIP TICKET REQUESTS
                    </h1>
                    <p class="opacity-70 mt-2">
                        Review, approve, or reject submitted trip tickets.
                    </p>
                </div>
            ...
            @forelse($requests as $note)
                ...
                @php
                    $state = match ($note->type) {
                        'trip_ticket_request' => ['Pending', 'badge-warning'],
                        'trip_ticket_approved' => ['Approved', 'badge-success'],
                        'trip_ticket_rejected' => ['Rejected', 'badge-error'],
                ...
                <div class="bg-base-100 border border-gray-300 rounded shadow-sm hover:shadow-md transition duration-300">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-8 flex justify-end">
                            ...
                            @if($note->type === 'trip_ticket_request')
                            ...
                            @else
                                ...
                                <span class="text-sm opacity-60">
                                    ...
                                    <strong>{{ str_replace('trip_ticket_', '', $note->type) }}</strong>.
                                </span>
